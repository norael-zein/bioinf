...
print()
print('----------------------------------------------------------')
print('--------Splitting and visualisation of sequences----------')
print('----------------------------------------------------------')
print('This is a script that can split the sequences up into categories in different ways.') 
print('It is also possible to visulaize the length distribution of the CDRs in the sequences (shown in graphs).')
print('Furthermore, it is possible to get results correlated to the sequences protein A motifs and also')
print('to achive csv-files that later can be used for histogram (using R). This script has multiple options regarding these results. For more information regaring each input, read the user manual.')
print('When asked to, please answer the questions with either Yes or No (note a large letter in the beginning).')
print()
print('--------------------------------------')
print('Type of sequences')
print('--------------------------------------')
print()
type_of_seq = input("What type of sequences contains the input file? Answer for example PATENT, NGS, etc: ")
print()
print('--------------------------------------')
print('Filtration')
print('--------------------------------------')
print()
filtration = input("Are you interested in filtering the sequences? Answer Yes or No: ")
print()
print('--------------------------------------')
print('CDR length distirbution - visualized in graphs')
print('--------------------------------------')
print()
...
# Filters the sequences with the constraint of having an amino acid
# at position 103 and contianing the last framework region (FR4). It is
# otherwise seen as irrelevant and is removed.
...
"""VISULAIZAITON OF ALL THREE CDRs LENGTH DISTIRBUTION"""
...
"""VISULAIZAITON OF CDR1 LENGTH DISTRIBUTION"""
# Generates a graph of the length distirbution of CDR1.
...
"""VISULAIZAITON OF CDR2 LENGTH DISTRIBUTION"""
# Generates a graph of the length distirbution of CDR2.
...
"""VISULAIZAITON OF CDR3 LENGTH DISTRIBUTION"""
# Generates a graph of the length distirbution of CDR3.
...
"""SPLITTING OF SEQUENCES ACCORDING TO CDR1 LENGTH"""
# Splits the sequences into two categorizes, one with standard length of CDR1 and one with 
# long length of CDR1. The threshold is set to 4% aminoacids. 
...
# Splits the sequences into two categorizes, one with standard length of CDR2 and one with 
# long length of CDR2. The threshold is set to 4% aminoacids.
